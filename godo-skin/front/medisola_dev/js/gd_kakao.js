...
$(document).ready(function () {
    ...
    if($kakaoLoginBtn.length > 0) {
        $kakaoLoginBtn.click(function () {
            ...
            var wanban = $kakaoLoginBtn.data('wanban');
            var autoSave = $('input[name="saveAutoLogin"]').is(':checked') ? 'y' : 'n';
            url = '../member/kakao/kakao_login.php?kakaoType=' + $kakaoLoginBtn.data('kakao-type') + '&returnUrl=' + returnUrl + '&saveAutoLogin=' + autoSave + '&wanban=' + wanban;
            var win = gd_popup({
