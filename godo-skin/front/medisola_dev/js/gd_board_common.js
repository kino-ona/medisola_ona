...
function gd_btn_view(bdId, sno, auth, bdTitle, title, index) {
    if (window.self !== window.top) {
        if (window.parent.amplitude) {
            window.parent.amplitude.logEvent('board_post_click', {board_title: bdTitle, post_id: sno, title: title, index: index});
        }
    } else {
        if (window.amplitude) {
            window.amplitude.logEvent('board_post_click', {board_title: bdTitle, post_id: sno, title: title, index: index});
        }
    }
