...
var DietQuiz = (function () {
    ...
    var DISEASE_CONDITIONS = [
        ...
        { id: 'breast-cancer', label: '유방암', subtitle: '유방암 케어가 필요한 분', color: '#EC4899', icon: 'pinkRibbon' }
    ];
    ...
    var ICONS = {
        ...
        pinkRibbon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 13.5C8.5 9 5 7 5 4.5 5 2.5 7 1.5 9 2.5c1.5.8 2.5 2 3 3.5.5-1.5 1.5-2.7 3-3.5 2-1 4 0 4 2C19 7 15.5 9 12 13.5z"/><path d="M17 22l-5-8.5L7 22"/></svg>',
    ...
    function getConditionIcon(iconName) {
        var map = { 'droplet':'droplet','baby':'baby','kidney':'kidney','ribbon':'ribbon','pinkRibbon':'pinkRibbon','heart':'heart','trending-down':'trendingDown','dumbbell':'dumbbell','smile':'smile','sprout':'sprout','trendingDown':'trendingDown','trendingUp':'trendingUp','shield':'shield' };
    ...
    function setStep(step) {
        state.step = step;
        saveToCache();
        if (!_skipHistoryPush && step !== 'analysis') {
            var url = location.pathname + location.search + (step === 'entry' ? '' : '#' + step);
    ...
    function goNext() {
        // 질환 2개 이상 선택 시 → 전문 상담 안내 페이지로 이동
        if (state.step === 'condition' &&
            state.selectedGoal === 'disease-management' &&
            state.conditions.length >= 2) {
            window.location.href = 'diet_consultation.php?goodsNo=' + encodeURIComponent(state.goodsNo);
            return;
        }
    ...
    function renderFooter(label, disabled) {
        if (state.step === 'entry' || state.step === 'analysis' || state.step === 'report') return '';
        return '<div class="dq-footer"><button class="dq-next-btn" onclick="DietQuiz.goNext()"' + (disabled ? ' disabled' : '') + '>' + label + ' ' + getIcon('arrowRight') + '</button></div>';
    }
        ...
        return '<div class="dq-screen active"><div class="dq-entry">' +
            ...
            '<div class="dq-entry-hero">' +
                ...
                '<div class="dq-entry-hero-content">' +
                    '<div class="dq-entry-brand"><svg width="140" height="18" viewBox="0 0 210 27" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_943_20)"><path d="M113.258 8.6498C113.451 9.1498 113.788 9.5998 114.318 9.9998C114.799 10.3998 115.522 10.7998 116.388 11.0998C117.255 11.4498 118.411 11.7498 119.807 12.0498C122.6 12.6998 124.671 13.5998 126.019 14.7498C127.368 15.8998 127.994 17.4498 127.994 19.4998C127.994 20.5998 127.801 21.6498 127.368 22.5498C126.934 23.4498 126.356 24.2498 125.586 24.8998C124.815 25.5498 123.949 26.0498 122.889 26.3998C121.83 26.7498 120.674 26.8998 119.422 26.8998C117.4 26.8998 115.57 26.5498 113.884 25.8998C112.199 25.2498 110.61 24.1998 109.117 22.7498L110.899 20.5998C112.199 21.8498 113.547 22.7498 114.896 23.3998C116.244 23.9998 117.785 24.2998 119.518 24.2998C121.204 24.2998 122.552 23.8998 123.612 23.0498C124.623 22.2498 125.152 21.1498 125.152 19.7998C125.152 19.1998 125.056 18.6498 124.864 18.1498C124.671 17.6498 124.334 17.1998 123.852 16.8498C123.371 16.4498 122.697 16.0998 121.83 15.7498C120.963 15.4498 119.904 15.0998 118.555 14.7998C117.111 14.4998 115.859 14.0998 114.799 13.6998C113.74 
 78.4428 24.3 79.6467 23.1C80.8505 21.9 81.8136 20.45 82.4878 18.8C83.1619 17.15 83.499 15.35 83.499 13.45C83.499 11.55 83.1619 9.75 82.4878 8.15C81.8136 6.5 80.8987 5.05 79.6467 3.85ZM78.3465 13.55C78.3465 14.85 78.1539 16.05 77.7205 17.1C77.2871 18.15 76.7093 19.1 75.987 19.9C75.2647 20.65 74.3016 21.3 73.2422 21.7C72.1828 22.15 70.9789 22.35 69.6788 22.35H64.8634V4.65H69.6788C70.9789 4.65 72.1828 4.9 73.2422 5.3C74.3016 5.75 75.2165 6.35 75.987 7.15C76.7574 7.95 77.3353 8.9 77.7205 9.95C78.1539 11.05 78.3465 12.25 78.3465 13.55Z" fill="currentColor"/><path d="M91.493 16.85H93.9488V0H89.0371V27H93.9488V21.9H91.493V16.85Z" fill="currentColor"/><path d="M101.316 16.8501V21.9501H96.4043V16.8501H101.316Z" fill="currentColor"/></g><defs><clipPath id="clip0_943_20m"><rect width="210" height="27" fill="white"/></clipPath></defs></svg></span></div>' +
    ...
    function renderDiseaseToggle() {
        ...
        return '<div class="dq-condition-section dq-disease-toggle-section">' +
            '<button class="dq-condition-item dq-disease-toggle' + selCls + '" onclick="DietQuiz.toggleCondition(\'disease-management\')">' +
                ...
                (isSelected ? '<div class="dq-condition-check">' + getIcon('check') + '</div>' : '') +
    ...
    function toggleCondition(id) {
        ...
        if (id === 'disease-management') {
            ...
            render();
            // 질환 관리 펼칠 때 질환 선택 섹션으로 스크롤
            if (state.showDiseaseSection) {
                setTimeout(function() {
                    var el = document.querySelector('.dq-disease-section');
        ...
        if (id === 'kidney') {
            ...
            if (state.showKidneyOptions) {
                setTimeout(function() {
                    var el = document.querySelector('.dq-kidney-sub');
    ...
    function renderAnalysis() {
        ...
        return '<div class="dq-screen active"><div class="dq-analysis"><div class="dq-analysis-card">' +
            /* Central animation */
            '<div class="dq-analysis-rings"><div class="dq-ripple"></div><div class="dq-ripple dq-ripple-2"></div><div class="dq-ripple dq-ripple-3"></div><div class="dq-ring-outer"></div><div class="dq-ring-inner"></div><div class="dq-ring-center"><div class="dq-ring-brain">' + getIcon('brain') + '</div></div></div>' +
    ...
    function fetchReportData() {
        $.ajax({
            ...
            success: function (res) {
                ...
                if (state._animationDone && state.step === 'analysis') setStep('report');
            },
            error: function () {
    ...
    function startAnalysisAnimation() {
        ...
        function advance() {
            ...
            if (cur > total) {
                ...
                if (state.isReportReady && state.step === 'analysis') setStep('report');
                return;
            }
            if (cur > 1) {
    ...
    function renderReport() {
        ...
        if (!r) {
            return '<div class="dq-screen active"><div class="dqr-report">' +
                '<div class="dqr-header"><div class="dqr-header-inner"><div class="dqr-header-titles">' +
        ...
        BMI_ZONES.forEach(function (z) {
            bmiZones += '<div class="dqr-bmi-zone" style="flex:' + z.pct + ';background-color:' + z.color + '"></div>';
            bmiLabels += '<div class="dqr-bmi-label-item" style="flex:' + z.pct + '">' + z.label + '</div>';
        });
        ...
        // Recommended disease diets (질환식 모드)
        var diseaseDiets = r.recommendedDiseaseDiets || [];
        var diseaseDietCards = '';
        diseaseDiets.forEach(function (dd, idx) {
            var benefits = '';
            (dd.benefits || []).forEach(function (b) {
                benefits += '<span class="dqr-benefit-tag" style="background-color:' + dd.color + '15;color:' + dd.color + '">' + b + '</span>';
            });
            diseaseDietCards += '<div class="dqr-line-card">' +
                '<div class="dqr-line-header">' +
                    '<span class="dqr-line-number" style="background-color:' + dd.color + '">' + (idx + 1) + '</span>' +
                    '<span class="dqr-line-label">' + dd.label + '</span>' +
                '</div>' +
                '<p class="dqr-line-reason">' + dd.reason + '</p>' +
                '<div class="dqr-line-benefits">' + benefits + '</div>' +
            '</div>';
        });
        var isDiseaseDietMode = diseaseDiets.length > 0;
        var solutionCards = isDiseaseDietMode ? diseaseDietCards : lineCards;
        var brandSvg = '<svg style="vertical-align:middle;margin-right:4px;" width="78" height="10" viewBox="0 0 210 27" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_943_20r)"><path d="M113.258 8.6498C113.451 9.1498 113.788 9.5998 114.318 9.9998C114.799 10.3998 115.522 10.7998 116.388 11.0998C117.255 11.4498 118.411 11.7498 119.807 12.0498C122.6 12.6998 124.671 13.5998 126.019 14.7498C127.368 15.8998 127.994 17.4498 127.994 19.4998C127.994 20.5998 127.801 21.6498 127.368 22.5498C126.934 23.4498 126.356 24.2498 125.586 24.8998C124.815 25.5498 123.949 26.0498 122.889 26.3998C121.83 26.7498 120.674 26.8998 119.422 26.8998C117.4 26.8998 115.57 26.5498 113.884 25.8998C112.199 25.2498 110.61 24.1998 109.117 22.7498L110.899 20.5998C112.199 21.8498 113.547 22.7498 114.896 23.3998C116.244 23.9998 117.785 24.2998 119.518 24.2998C121.204 24.2998 122.552 23.8998 123.612 23.0498C124.623 22.2498 125.152 21.1498 125.152 19.7998C125.152 19.1998 125.056 18.6498 124.864 18.1498C124.671 17.6498 124.334 17.1998 123.852 16.8498C123.371 16.4498 122.697 16.0998 121.83 15.7498C120.963 15.4498 119.904 15.0998 118.555 14.7998C117.111 14.4998 115.859 14.0998 114.799 13.6998C113.74 13.2998 112.873 12.7498 112.151 12.1498C111.477 11.5498 110.947 10.8498 110.61 10.0498C110.273 9.2498 110.128 8.2998 110.128 7.1998C110.128 6.1498 110.321 5.1998 110.754 4.3498C111.14 3.4998 111.718 2.7498 112.488 2.0998C113.21 1.4498 114.125 0.949805 115.088 0.599805C116.1 0.249805 117.207 0.0498047 118.411 0.0498047C120.241 0.0498047 121.878 0.299805 123.226 0.849805C124.623 1.3998 125.923 2.1498 127.223 3.2498L125.586 5.4998C124.43 4.4998 123.226 3.7998 122.071 3.3498C120.867 2.8998 119.663 2.6998 118.363 2.6998C117.544 2.6998 116.822 2.7998 116.148 3.0498C115.474 3.2498 114.944 3.5498 114.462 3.9498C113.981 4.3498 113.644 4.7498 113.403 5.2998C113.162 5.7998 113.018 6.3998 113.018 6.9998C112.97 7.5498 113.066 8.1498 113.258 8.6498Z" fill="currentColor"/><path d="M157.464
987 7.15C76.7574 7.95 77.3353 8.9 77.7205 9.95C78.1539 11.05 78.3465 12.25 78.3465 13.55Z" fill="currentColor"/><path d="M91.493 16.85H93.9488V0H89.0371V27H93.9488V21.9H91.493V16.85Z" fill="currentColor"/><path d="M101.316 16.8501V21.9501H96.4043V16.8501H101.316Z" fill="currentColor"/></g><defs><clipPath id="clip0_943_20r"><rect width="210" height="27" fill="white"/></clipPath></defs></svg>';
        var solutionLabel = isDiseaseDietMode ? brandSvg + ' 추천 질환식' : brandSvg + ' 케어 솔루션';
        ...
        return '<div class="dq-screen active"><div class="dqr-report">' +
            /* ---- Header ---- */
            '<div class="dqr-header"><div class="dqr-header-inner">' +
                '<button class="dqr-back-btn" onclick="DietQuiz.goBack()" aria-label="뒤로">' + getIcon('arrowLeft') + '</button>' +
                '<div class="dqr-header-titles">' +
                    '<h2 class="dqr-header-title"><svg style="vertical-align:middle;margin-right:4px;" width="82" height="11" viewBox="0 0 210 27" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_943_20h)"><path d="M113.258 8.6498C113.451 9.1498 113.788 9.5998 114.318 9.9998C114.799 10.3998 115.522 10.7998 116.388 11.0998C117.255 11.4498 118.411 11.7498 119.807 12.0498C122.6 12.6998 124.671 13.5998 126.019 14.7498C127.368 15.8998 127.994 17.4498 127.994 19.4998C127.994 20.5998 127.801 21.6498 127.368 22.5498C126.934 23.4498 126.356 24.2498 125.586 24.8998C124.815 25.5498 123.949 26.0498 122.889 26.3998C121.83 26.7498 120.674 26.8998 119.422 26.8998C117.4 26.8998 115.57 26.5498 113.884 25.8998C112.199 25.2498 110.61 24.1998 109.117 22.7498L110.899 20.5998C112.199 21.8498 113.547 22.7498 114.896 23.3998C116.244 23.9998 117.785 24.2998 119.518 24.2998C121.204 24.2998 122.552 23.8998 123.612 23.0498C124.623 22.2498 125.152 21.1498 125.152 19.7998C125.152 19.1998 125.056 18.6498 124.864 18.1498C124.671 17.6498 124.334 17.1998 123.852 16.8498C123.371 16.4498 122.697 16.0998 121.83 15.7498C120.963 15.4498 119.904 15.0998 118.555 14.7998C117.111 14.4998 115.859 14.0998 114.799 13.6998C113.74 13.2998 112.873 12.7498 112.151 12.1498C111.477 11.5498 110.947 10.8498 110.61 10.0498C110.273 9.2498 110.128 8.2998 110.128 7.1998C110.128 6.1498 110.321 5.1998 110.754 4.3498C111.14 3.4998 111.718 2.7498 112.488 2.0998C113.21 1.4498 114.125 0.949805 115.088 0.599805C116.1 0.249805 117.207 0.0498047 118.411 0.0498047C120.241 0.0498047 121.878 0.299805 123.226 0.849805C124.623 1.3998 125.923 2.1498 127.223 3.2498L125.586 5.4998C124.43 4.4998 123.226 3.7998 122.071 3.3498C120.867 2.8998 119.663 2.6998 118.363 2.6998C117.544 2.6998 116.822 2.7998 116.148 3.0498C115.474 3.2498 114.944 3.5498 114.462 3.9498C113.981 4.3498 113.644 4.7498 113.403 5.2998C113.162 5.7998 113.018 6.3998 113.018 6.9998C112.97 7.5498 113.066 8.1498 113.258 8.6498Z" fill
5.75 75.2165 6.35 75.987 7.15C76.7574 7.95 77.3353 8.9 77.7205 9.95C78.1539 11.05 78.3465 12.25 78.3465 13.55Z" fill="currentColor"/><path d="M91.493 16.85H93.9488V0H89.0371V27H93.9488V21.9H91.493V16.85Z" fill="currentColor"/><path d="M101.316 16.8501V21.9501H96.4043V16.8501H101.316Z" fill="currentColor"/></g><defs><clipPath id="clip0_943_20h"><rect width="210" height="27" fill="white"/></clipPath></defs></svg> 영양 분석 결과</h2>' +
            ...
            /* ---- Coaching Hero ---- */
            '<div class="dqr-hero">' +
                '<div class="dqr-hero-icon">' + getIcon('activity') + '</div>' +
                '<div class="dqr-hero-body">' + coachingHtml + '</div>' +
            '</div>' +
            ...
            '<div class="dqr-content">' +
                '<div class="dqr-columns">' +
                    ...
                    '<div class="dqr-col-left">' +
                        /* BMI Analysis */
                        '<div class="dqr-card">' +
                            '<p class="dqr-section-label">체질량 분석 <span class="dqr-section-hint">(BMI-비만도를 측정하는 표준지표)</span></p>' +
                            ...
                            '</div>' +
                            '<div class="dqr-bmi-labels">' + bmiLabels + '</div>' +
                        '</div>' +
                        /* Daily Nutrients */
                        '<div class="dqr-card">' +
                    ...
                    '<div class="dqr-col-right">' +
                        ...
                        '</div>' +
                        /* Recommended Lines / Disease Diets */
                        '<div class="dqr-card">' +
                            '<p class="dqr-section-label">' + solutionLabel + '</p>' +
                            '<div class="dqr-lines">' + solutionCards + '</div>' +
                            (condBadges ? '<div class="dqr-conditions-row"><span class="dqr-conditions-label">선택한 건강 목표:</span>' + condBadges + '</div>' : '') +
                        '</div>' +
                    '</div>' +
                '</div>' +
            '</div>' +
            /* Brand Message — 모바일은 하단 배치 */
            '<div class="dqr-brand">' +
    ...
    function saveAndRedirect() {
        ...
        $.ajax({
            ...
            data: {
                ...
                recommendedDiseaseDiets: JSON.stringify(state.reportData && state.reportData.recommendedDiseaseDiets ? state.reportData.recommendedDiseaseDiets : [])
            },
            dataType: 'json',
            success: function (res) {
    ...
    function init(opts) {
        ...
        if (urlParams.get('showReport') === '1') {
            try {
                ...
                if (saved && saved.goodsNo == state.goodsNo && saved.reportData) {
                    ...
                    state.step = 'report';
                    history.replaceState({ step: 'report' }, '', '#report');
                    render();
                    return;
                }
            } catch (e) {}
        ...
        // ── History API: SPA 뒤로가기 · 새로고침 지원 ──
        var navType = 'navigate';
        try { navType = performance.getEntriesByType('navigation')[0].type; } catch(e) {}

        var hash = location.hash.replace('#', '');
        // analysis/report는 데이터 유실되므로 condition으로 복원
        if (hash === 'analysis' || hash === 'report') hash = 'condition';
        var validStep = hash && STEP_ORDER.indexOf(hash) !== -1;

        if (navType !== 'navigate' && validStep) {
            // 새로고침 · back_forward → hash 기준 단계 복원
            state.step = hash;
        } else {
            // 최초 진입(주소창 직접 입력 · 링크 클릭) → 첫 화면
            state.step = 'entry';
        }

        var initUrl = location.pathname + location.search + (state.step === 'entry' ? '' : '#' + state.step);
        history.replaceState({ step: state.step }, '', initUrl);
