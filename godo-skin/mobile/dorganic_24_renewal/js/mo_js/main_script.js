        ...
        pagination: {
			...
			renderCustom: function (swiper, current, total) {
				...
				if( m_total > 9 && m_current > 9) {				
					return '<span class="current">' + current + '</span><img src="/data/skin/mobile/dorganic_24_renewal/img/mimg/slash.svg" /><span class="total">' + total + "</span>"; 
				} else if ( m_total > 9 && m_current<=9 ){				
					return '<span class="current">0' + current + '</span><img src="/data/skin/mobile/dorganic_24_renewal/img/mimg/slash.svg" /><span class="total">' + total + "</span>"; 
				} else {		
					return '<span class="current">0' + current + '</span><img src="/data/skin/mobile/dorganic_24_renewal/img/mimg/slash.svg" /><span class="total">' + '0' + total + "</span>"; 
				}
			}
        },
	});
