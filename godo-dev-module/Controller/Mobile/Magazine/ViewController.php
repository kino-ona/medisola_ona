...
/**
 * Magazine View Controller (Mobile)
 * Displays single WordPress magazine article with related articles for mobile
 */
class ViewController extends \Controller\Mobile\Controller
{
    public function index()
    {
        ...
        if ($articleId <= 0) {
            ...
            header('Location: /m/magazine/list.php');
            exit;
        }
        ...
        try {
            ...
            \Logger::channel('wordpress')->error('Magazine view controller error (mobile)', [
