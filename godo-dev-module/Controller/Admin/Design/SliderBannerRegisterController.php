    ...
    try {
      ...
      if (isset($getValue['sno']) === true) {
        ...
        foreach ($bannerInfo as $info) {
          ...
          $getData['bannerInfo'][$i]['bannerBadgeText'] = $info['bannerBadgeText'];
          $getData['bannerInfo'][$i]['bannerMainTitle'] = $info['bannerMainTitle'];
          $getData['bannerInfo'][$i]['bannerSubtitle'] = $info['bannerSubtitle'];
          $getData['bannerInfo'][$i]['bannerButtonTitle'] = $info['bannerButtonTitle'];
          $getData['bannerInfo'][$i]['bannerForegroundColor'] = $info['bannerForegroundColor'];
      ...
      if (empty(gd_isset($getData['bannerInfo'])) === true) {
        for ($i = 0; $i <= 2; $i++) {
          ...
          $getData['bannerInfo'][$i]['bannerBadgeText'] = '';
          $getData['bannerInfo'][$i]['bannerMainTitle'] = '';
          $getData['bannerInfo'][$i]['bannerSubtitle'] = '';
          $getData['bannerInfo'][$i]['bannerButtonTitle'] = '';
          $getData['bannerInfo'][$i]['bannerForegroundColor'] = '';
        }
      }
