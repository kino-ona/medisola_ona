...
class SubscriptionCardListController extends \Controller\Admin\Controller
{
    public function index()
    {
        ...
        if ($obj->applyFl) {
            ...
            $sql = "SELECT COUNT(*) as cnt FROM wm_subscription_cards AS a LEFT JOIN " . DB_MEMBER . " AS m ON a.memNo = m.memNo{$conds}";
            $row = $db->fetch($sql);
            ...
            $page = App::load("\Component\Page\Page", $page, $total, $amount);
