    ...
    public function index()
    {
        ...
        try {
            ...
            if (strcmp("0000", $in["resultCode"]) == 0) {
                ...
                $password = $merchantData[0];//$in['merchantData'];
        ...
        if ($bool && $password && $billing_key) {
            $bankNm = $pgBanks[$resultMap['CARD_BankCode']];
            ...
            if (empty($bankNm))
                $bankNm = $pgCards[$resultMap['CARD_Code']];
        ...
        $this->js("alert('결제 카드 등록에 실패하였습니다.');");
        exit;
    }
}