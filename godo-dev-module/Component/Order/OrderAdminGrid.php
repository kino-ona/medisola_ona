...
class OrderAdminGrid	extends \Bundle\Component\Order\OrderAdminGrid
{
    //본사
 ...
 */
    ...
    {
		//return parent::getSelectOrderGridConfigList($orderGridMode);
    ...
    {
		//return parent::getAllOrderGridConfigList($orderGridMode, $gridSort);
    ...
    {
		//return parent::getOrderGridConfigList($orderGridMode);
    ...
    {
		//return parent::getOrderGridConfigAllSortList($orderGridMode, $gridSort);
    ...
    {
		//return parent::getLinkOptionConfigList($orderGridList);
    ...
    {
		//parent::setOrderGridConfigList($postValue);
    ...
    public function getOrderAdminGridMode($viewType)
    {
        switch(\Request::getFileUri()){
            ...
            case 'scheduled_delivery.php' :
                return 'list_goods_scheduled_delivery';
            default:
                return parent::getOrderAdminGridMode($viewType);
        }
    }
}
