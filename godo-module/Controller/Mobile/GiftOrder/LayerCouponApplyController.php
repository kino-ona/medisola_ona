...
use Component\GiftOrder\CartGift as CartAdmin;
    ...
    public function index()
    {
        try {
            ...
            if(Session::has('member')) {
                ...
                $memberCouponArrData = $coupon->getGoodsMemberCouponList($goodsCartInfo[0]['goodsNo'],Session::get('member.memNo'),Session::get('member.groupSno'), null, $nowMemberCouponNoArr, 'gift');
