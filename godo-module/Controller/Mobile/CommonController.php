...
class CommonController
{
    ...
    public function __construct()
    {
        ...
        $this->menuTree = [
            ((\Request::getRemoteAddress() == '183.98.27.142') || (\Request::getRemoteAddress() == '220.120.152.115')) ? [
                'id' => 'find_my_meal',
                'text' => [
                    'default' => '나만의 식단 플랜'
                ],
    ...
    public function index($controller)
    {
        ...
        $activeMenu = $this->getActiveMenu($this->menuTree);

        $controller->setData('menuTree', $this->menuTree);
        $controller->setData('activeMenu', $activeMenu);
    }
    ...
    protected function getActiveMenu(array $menuTree)
    {
