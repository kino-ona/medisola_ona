...
class HomeReviewPsController extends \Controller\Front\Controller
{
    ...
    private function handleGetTab()
    {
        try {
            ...
            Logger::channel('crema')->error('HomeReviewPs get_tab error', [
    ...
    private function handleGetTabReviews()
    {
        try {
            ...
            Logger::channel('crema')->error('HomeReviewPs get_tab_reviews error', [
                'message' => $e->getMessage(),
            ]);
            $this->json(['error' => 1, 'message' => 'Server error']);
        }
    ...
    private function handleGetGroupReviews()
    {
        try {
            ...
            Logger::channel('crema')->error('HomeReviewPs get_group_reviews error', [
                'message' => $e->getMessage(),
            ]);
            $this->json(['error' => 1, 'message' => 'Server error']);
        }
    ...
    private function handleGetMoreReviews()
    {
        try {
            ...
            Logger::channel('crema')->error('HomeReviewPs get_more_reviews error', [
                'message' => $e->getMessage(),
            ]);
            $this->json(['error' => 1, 'message' => 'Server error']);
        }
