...
class AddGoodsPsController extends \Bundle\Controller\Admin\Goods\AddGoodsPsController
{
    /**
     * 추가상품  처리 페이지
                        ...
                        if (gd_isset($postValue['optionNm'])) {
                            ...
                            foreach ($postValue['goodsPrice'] as $k => $v) {
                                if (trim($v) != '') {
                                    ...
                                    $subImgData = array();
                                    if (empty($fileValue['subImageNm']['name'][$k]) === false) {
                                        $subImgData = array(
                                            'name' => $fileValue['subImageNm']['name'][$k],
                                            'type' => $fileValue['subImageNm']['type'][$k],
                                            'tmp_name' => $fileValue['subImageNm']['tmp_name'][$k],
                                            'error' => $fileValue['subImageNm']['error'][$k],
                                            'size' => $fileValue['subImageNm']['size'][$k]
                                        );
                                    }
                                    ...
                                    $arrData = array(
                                        ...
                                        'limitCnt' => gd_isset($postValue['limitCnt']),
                                        'premiumMultiplier' => gd_isset($postValue['premiumMultiplier'], 1),
                                        'tags' => gd_isset($postValue['tags']),
                                        'goodsSummary' => gd_isset($postValue['goodsSummary']),
                                    ...
                                    if ($postValue['mode'] =='register_ajax') {
                                        ...
                                        $arrData['subImage'] = rawurlencode(gd_html_add_goods_image($arrData['addGoodsNo'], $arrData['subImageNm'], $arrData['imagePath'], $arrData['imageStorage'], 30, $arrData['goodsNm'], '_blank'));
