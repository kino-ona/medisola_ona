        ...
        <tr>
            ...
            <td>
                <select name="joinedVia" >
                    ...
                    <?php foreach ($joinedViaOptions as $val) { ?>
                        <option value=<?= $val["joinedVia"] ?> <?= ($search['joinedVia'] == $val["joinedVia"]) ? "selected" : "" ?>><?= $val["joinedVia"] ?> / <?= number_format($val["count"]) ?></option>
                    <?php } ?>
                </select>
            </td>
        </tr>
