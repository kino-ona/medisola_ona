...
<form id="frmSearchOrder" method="get" class="js-form-enter-submit">
    ...
    <div class="search-detail-box">
        <table class="table table-cols">
			...
			<!--// 웹앤모바일 2023-08-22 첫 배송일 검색 추가-->
			<tr>
				<th>첫배송일 검색</th>
				<td colspan="3">
					<div class="form-inline">
                        <div class="input-group js-datepicker">
                            <input type="text" name="firstDelivery[]" value="<?= $search['firstDelivery'][0]; ?>" class="form-control width-xs">
                                <span class="input-group-addon">
                                    <span class="btn-icon-calendar">
                                    </span>
                                </span>
                        ...
                        ~
                        <div class="input-group js-datepicker">
                            <input type="text" name="firstDelivery[]" value="<?= $search['firstDelivery'][1]; ?>" class="form-control width-xs">
                                <span class="input-group-addon">
                                    <span class="btn-icon-calendar">
                                    </span>
                                </span>
