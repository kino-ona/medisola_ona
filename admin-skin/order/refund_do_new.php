                    ...
                    <?php if ($wmSubscription) { ?>
                        ...
                        <script>
                            $(document).ready(function (){
                                $('#refundMethod').val('복합환불');
                                $('input[name="info[completeCashPrice]"]').val(0);
                                $('input[name="info[completeCashPrice]"]').prop('disabled', true);
                                $('input[name="info[completePgPrice]"]').val(0);
                                $('input[name="info[completePgPrice]"]').prop('disabled', true);
                                $('input[name="info[completeDepositPrice]"]').val(0);
                                $('input[name="info[completeDepositPrice]"]').prop('disabled', true);
                                $('input[name="info[completeMileagePrice]"]').after('<span class="notice-danger mgl15">정기결제주문 환불시에는 기타 환불 금액 입력만 가능합니다. 상품 금액만 환불 시에는 배송비 환불 금액을 먼저 0으로 수정하세요.</span>');
                            });
                        </script>
                        <style>
                            #refundMethod {display:none}
                            #refundBank {display:none}
                        </style>
                    <?php } ?>
