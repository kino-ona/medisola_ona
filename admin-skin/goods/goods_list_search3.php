            ...
            <tr>
                ...
                <td style="width:500px;wwww">
                    <div class="form-inline">
						...
						<?php if ($isGift) : ?>
						<!--/ <input type='checkbox' name='useGift' value='1'<?/*=$search['useGift']?" checked":""*/?> id='useGift'><label for='useGift'>선물하기 상품</label>-->
						<?php endif; ?>
                    </div> 
                </td>
                ...
                <th>선물하기상품여부</th>
                <td>
                    <select name="useGift" id="useGift" class="form-control">
                        <option value="all" <?php if($gift == 'all'){ ?> selected="selected" <?php } ?>>전체</option>
                        <option value="common" <?php if($gift == 'common'){ ?> selected="selected" <?php } ?>>일반상품</option>
                        <option value="1" <?php if($gift == '1'){ ?> selected="selected" <?php } ?>>선물하기상품</option>
                    </select>
                </td>
            </tr>
            <tr>
