<form id="frmCommonContent" name="frmCommonContent" action="common_content_ps.php" method="post" target="ifrmProcess">
    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="form-inline">
                    <label class="radio-inline"><input type="radio" name="commonPositionType" value="top" <?=$checked['commonPositionType']['top']; ?>>상품상세 상단</label>
                    <label class="radio-inline"><input type="radio" name="commonPositionType" value="bottom" <?=$checked['commonPositionType']['bottom']; ?>>상품상세 하단</label>
                    <span class="notice-info"> 상품 상세페이지에서 공통정보가 표시될 위치를 선택하세요. (상단: 개별 상품 상세 위, 하단: 개별 상품 상세 아래)</span>
                </div>
            </td>
        </tr>
    </table>
