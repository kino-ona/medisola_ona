...
<form id="frmSearchGoods" name="frmSearchGoods" method="get" class="js-form-enter-submit">
    ...
    <div class="search-detail-box">
        ...
        <table class="table table-cols">
            ...
            <?php } ?>
            <tr>
                <?php if($useEarlyDelivery){?>
                <th>상품유형</th>
                <td colspan="4">
                    <div class="form-inline">
                        <select name="useEarlyDelivery" class="form-control">
                            <option value="all" <?php if($useEarlyDelivery == 'all'){ ?> selected="selected" <?php } ?>>전체</option>
                            <option value="common" <?php if($useEarlyDelivery == 'common'){ ?> selected="selected" <?php } ?>>일반상품</option>
                            <option value="1" <?php if($useEarlyDelivery == '1'){ ?> selected="selected" <?php } ?>>새벽배송상품</option>
                        </select>
                    </div>
                </td>
                <?php }else if($useGoodsViewIcon){?>
                    <th>아이콘설정여부</th>
                    <td colspan="4">
                        <div class="form-inline">
                            <select name="useGoodsViewIcon" class="form-control">
                                <option value="all" <?php if($useGoodsViewIcon == 'all'){ ?> selected="selected" <?php } ?>>전체</option>
                                <option value="1" <?php if($useGoodsViewIcon == '1'){ ?> selected="selected" <?php } ?>>설정</option>
                                <option value="common" <?php if($useGoodsViewIcon == 'common'){ ?> selected="selected" <?php } ?>>미설정</option>
                            </select>
                        </div>
                    </td>
                <?php }else {?>
                ...
                <td colspan="4">
                    <div class="form-inline">
                        <select name="useGoodsViewBanner" class="form-control">
                            <option value="all" <?php if($useGoodsViewBanner == 'all'){ ?> selected="selected" <?php } ?>>전체</option>
                            <option value="1" <?php if($useGoodsViewBanner == '1'){ ?> selected="selected" <?php } ?>>설정</option>
                            <option value="common" <?php if($useGoodsViewBanner == 'common'){ ?> selected="selected" <?php } ?>>미설정</option>
                        </select>
                    </div>
                </td>
                <?php } ?>
