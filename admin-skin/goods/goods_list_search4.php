    ...
    <div class="search-detail-box">
        ...
        <table class="table table-cols">
            ...
            <tr>
                ...
                <th>첫배송일 사용여부</th>
                <td>
                    <select name="firstDelivery" id="firstDelivery" class="form-control">
                        <option value="all" <?php if($search['firstDelivery'] == 'all'){ ?> selected="selected" <?php } ?>>전체</option>
                        <option value="y" <?php if($search['firstDelivery'] == 'y'){ ?> selected="selected" <?php } ?>>사용</option>
                        <option value="n" <?php if($search['firstDelivery'] == 'n'){ ?> selected="selected" <?php } ?>>미사용</option>
                    </select>
                </td>
            </tr>
            <tr>
