...
<table class="table table-cols">
    ...
    <tr>
        <th>전화번호</th>
        <td><?= ((empty($data['receiverPhone']) === false && count($data['receiverPhone']) > 1 && empty($data['isDefaultMall'])) ? '(' . gd_isset($data['receiverPhonePrefix']) . ') ' : '') . (gd_isset($withdrawnMembersPersonalData['receiverPhone']) ? gd_isset($withdrawnMembersPersonalData['receiverPhone']) : gd_isset(implode("-", $data['receiverPhone']))); ?></td>
    </tr>
    <tr>
        <th>휴대폰번호</th>
        <td>
