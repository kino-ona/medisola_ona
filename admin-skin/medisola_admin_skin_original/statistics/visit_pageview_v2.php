...
<script>
    ...
    $(document).ready(function () {
        ...
        var container = document.getElementById('chart-area'),
            data = {
                categories: [<?= implode(',', $pvChart['Date']); ?>],
                series: [
                    {
                        name: '페이지뷰',
                        data: [<?= implode(',', $pvChart['pvCnt']); ?>]
                    },
                    {
                        name: '신규방문자PV',
                        data: [<?= implode(',', $pvChart['pvNewCnt']); ?>]
                    },
                    {
                        name: '재방문자PV',
                        data: [<?= implode(',', $pvChart['pvReCnt']); ?>]
                    },
                    {
                        name: '방문자수',
                        data: [<?= implode(',', $pvChart['pvVisitTotal']); ?>]
                    },
                    {
                        name: '방문자당PV',
                        data: [<?= implode(',', $pvChart['pvVisit']); ?>]
                    }
                ]
            },
            options = {
