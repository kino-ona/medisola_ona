    ...
    <div class="container">
        <div class="navbar-inner">
            ...
            <div class="navbar-header">
                ...
                <span class="<?php if (Globals::get('gLicense.ecCode') !== 'rental_mx_saas') { echo Globals::get('gLicense.ecKind'); } ?>"></span>
                <?php if (gd_is_provider() === false) { ?>
                    <?php if ((Globals::get('gLicense.ecCode') === 'rental_mx_pro' || Globals::get('gLicense.ecCode') === 'rental_mx_saas') && Globals::get('gLicense.restDay') <= 60) { ?>
