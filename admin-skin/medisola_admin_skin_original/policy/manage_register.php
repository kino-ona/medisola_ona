            ...
            <td class="form-inline">
                <?php if ($data['mode'] == 'register') { ?>
                    <dl class="dl-horizontal">
                        ...
                        <dd class="mgl0"><input type="password" name="managerPw" class="form-control width-lg" maxlength="16"/></dd>
                        <dt style="width:100px" class="mgt5">비밀번호확인</dt>
                        <dd class="mgt5 mgl0"><input type="password" name="managerPwRe" class="form-control width-lg" maxlength="16"/></dd>
                    </dl>
                <?php } else { ?>
                    ...
                    <div title="관리자 비밀번호를 입력해주세요!" id="mod_managerPw" class="display-none mgt5">
                        <dl class="dl-horizontal">
                            <dt style="width:100px">비밀번호</dt>
                            <dd class="mgl0"><input type="password" name="modManagerPw" class="form-control width-sm" maxlength="16"/></dd>
                            <dt style="width:100px" class="mgt5">비밀번호확인</dt>
                            <dd class="mgt5 mgl0"><input type="password" name="modManagerPwRe" class="form-control width-sm" maxlength="16"/></dd>
                        </dl>
                    </div>
                <?php } ?>
...
<?php } else { ?>
    <div class="<?php echo ($data['sno'] != DEFAULT_CODE_SCMNO && $data['isSuper'] == 'y') ? 'display-none' : ''; ?>">
        ...
        <table class="table table-cols">
            ...
            <?php if (($useGodoPro === true || $useGodoSass === true) && $data['scmNo'] == DEFAULT_CODE_SCMNO) { ?>
