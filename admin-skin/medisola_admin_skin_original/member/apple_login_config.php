            ...
            <td>
                ...
                <table class="table table-cols simpleJoin">
                    ...
                    <tr>
                        ...
                        <td>필수 :
                            <?= implode(", ", $data['items']['baseInfo']['requireY']);?>
                        </td>
                    </tr>
                    <tr>
                        <td>선택 :
                            <?= implode(", ", $data['items']['baseInfo']['requireN']);?>
                        </td>
                    </tr>
                    ...
                    <tr >
                        ...
                        <td>필수 :
                            <?= implode(", ", $data['items']['supplementInfo']['requireY']);?>
                        </td>
                    </tr>
                    <tr>
                        <td>선택 :
                            <?= implode(", ", $data['items']['supplementInfo']['requireN']);?>
                        </td>
                    </tr>
                    <tr>
                        <th rowspan="2">
