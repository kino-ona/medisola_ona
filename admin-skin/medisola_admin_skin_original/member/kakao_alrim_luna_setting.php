    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td class="form-inline">
                ...
                <div class="notice-danger mgt5"> <a href="https://lunasoft.co.kr/home/main/page/service/lunatalk" target="_blank" class="btn-link text-red">[루나소프트 알림톡 발신번호]</a>와 <a href="../member/sms_auto.php" target="_blank" class="btn-link text-red">[고도몰 SMS 발신번호]</a>가 동일해야 알림톡이 발송됩니다.</div>
                <div class="notice-info">루나소프트 관리자에서 알림톡 발신번호 변경 시 루나소프트 알림톡 계정(루나소프트 아이디) 삭제 후 재등록 해주셔야만 알림톡이 발송됩니다.</div>
